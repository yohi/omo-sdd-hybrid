...
* [x] Task-101: Issue #101 対応: CIでbun test必須化 (Scope: `.github/workflows/ci.yml`, `.github/workflows/publish.yml`, `README.md`)
* [ ] Task-102: Issue #102 対応: 監査ログ（guard-mode.log）のローテーション/保全/重要イベント構造化 (Scope: `.opencode/lib/access-policy.ts`, `__tests__/lib/access-policy.test.ts`, `specs/tasks.md`)
