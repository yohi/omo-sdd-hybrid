...
* システムは [認証要件の具体的な記述] **shall** する。

* システムは [機能要件の具体的な記述] **shall** する。

* システムは [その他要件の具体的な記述] **shall** する。

### 技術的制約

* システムは **[言語]** および **[フレームワーク]** を使用して構築 **must** する。

* すべてのコマンド実行は **Devcontainer** 環境内で行わ **must** なければならない。
